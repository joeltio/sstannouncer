...
import com.sst.announcements.Feed.Feed;
import com.sst.announcements.Feed.FeedNotificationAdaptor;
import com.sst.announcements.Feed.RSSParser;
import com.sst.announcements.Feed.XML;
import com.sst.announcements.R;
import com.sst.announcements.event.Event;
import com.sst.announcements.event.EventController;
import com.sst.announcements.event.EventHandler;
...
import com.sst.announcements.service.ResourceService;
...
public class AndroidServiceAdaptor extends Service
{
    public static final String INTENT_EXTRA_START_BOOTUP =
            "sstinc.com.sst.announcements.service.start_up.intent.extra.boot";
    public static final String INTENT_EXTRA_REMOTE_MESSENGER =
        "sstinc.com.sst.announcements.service.connect.extra.remote_messenger";
